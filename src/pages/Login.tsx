...
export const Login = () => { 
  const [userInfo, changeHandler] = useInput<UserType>({username: '', password: ''})
    ...
    <Container fluid className="d-flex align-items-center bg-dark" style={{height: '100vh'}}>
      <Form onSubmit={submitHanlder} className="w-100">
        ...
        <Form.Group className='mb-2'>
          ...
          <Form.Control id='password' type='password' onChange={changeHandler} value={userInfo.password} required/>
        </Form.Group>
